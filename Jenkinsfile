    ...
    agent any
      stages {
        ...
        stage('SonarQube - SAST') {
          ...
          sh "mvn clean verify sonar:sonar -Dsonar.projectKey=numeric-application -Dsonar.projectName='numeric_application' -Dsonar.host.url=http://devsecops-demo-1.eastus.cloudapp.azure.com:9000"
          }
